...
from vocabulary_srv.dbrepository import FeedbackRepository
...
def test_feedback_subscribe(app):
    ...
    with app.app_context():
        assert FeedbackRepository.get_count() == 0  # No entries in the table
    ...
    with app.app_context():
        assert FeedbackRepository.get_count() == 1  # Exactly one entry in the table
